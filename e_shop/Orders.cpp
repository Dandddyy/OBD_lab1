...
void Orders::Print() {
	if (IdOrder != 0) {
		cout << "ID: " << IdOrder << endl;
		cout << "Ім'я: " << nameOrder <<" "<< snameOrder << endl;
		cout << "Тип: " << typeOrder << endl;
...
void Orders::AddToFile(string NameF) {
	...
	if (fout.is_open()) {
		fout << "ID: " << IdOrder << endl;
		fout << "Ім'я: " << nameOrder << " " << snameOrder << endl;
		fout << "Тип: " << typeOrder << endl;
